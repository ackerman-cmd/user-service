...
CREATE TABLE user_service.oauth2_registered_client
(
...
CREATE TABLE user_service.oauth2_authorization
(
    id                            VARCHAR(100) NOT NULL PRIMARY KEY,
...
CREATE TABLE user_service.oauth2_authorization_consent
(
    registered_client_id VARCHAR(100)  NOT NULL,
    principal_name       VARCHAR(200)  NOT NULL,
